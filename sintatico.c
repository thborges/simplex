...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_MAX = 3,                    /* TOK_MAX  */
  YYSYMBOL_TOK_MIN = 4,                    /* TOK_MIN  */
  YYSYMBOL_TOK_INTEGER = 5,                /* TOK_INTEGER  */
  YYSYMBOL_TOK_DOUBLE = 6,                 /* TOK_DOUBLE  */
  YYSYMBOL_TOK_STRING = 7,                 /* TOK_STRING  */
  YYSYMBOL_TOK_GE = 8,                     /* TOK_GE  */
  YYSYMBOL_TOK_LE = 9,                     /* TOK_LE  */
  YYSYMBOL_TOK_EQ = 10,                    /* TOK_EQ  */
  YYSYMBOL_11_ = 11,                       /* ';'  */
  YYSYMBOL_12_ = 12,                       /* '+'  */
  YYSYMBOL_13_ = 13,                       /* '-'  */
  YYSYMBOL_YYACCEPT = 14,                  /* $accept  */
  YYSYMBOL_modelo = 15,                    /* modelo  */
  YYSYMBOL_restricoes = 16,                /* restricoes  */
  YYSYMBOL_objetivo = 17,                  /* objetivo  */
  YYSYMBOL_restricao = 18,                 /* restricao  */
  YYSYMBOL_linear_expr = 19,               /* linear_expr  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOK_MAX", "TOK_MIN",
  "TOK_INTEGER", "TOK_DOUBLE", "TOK_STRING", "TOK_GE", "TOK_LE", "TOK_EQ",
  "';'", "'+'", "'-'", "$accept", "modelo", "restricoes", "objetivo",
  "restricao", "linear_expr", "term", "constant", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* modelo: objetivo restricoes  */
#line 75 "simplex.y"
                                { }
#line 1144 "sintatico.c"
    break;

  case 3: /* restricoes: restricoes restricao ';'  */
#line 79 "simplex.y"
                                     {  }
#line 1150 "sintatico.c"
    break;

  case 4: /* restricoes: restricao ';'  */
#line 80 "simplex.y"
                                     {  }
#line 1156 "sintatico.c"
    break;

  case 5: /* objetivo: TOK_MAX linear_expr ';'  */
#line 84 "simplex.y"
                        { maxmin = '>';
			  copy_to_row(0, -1);
			  namerows[0].name = "z";
...
#line 1166 "sintatico.c"
    break;

  case 6: /* objetivo: TOK_MIN linear_expr ';'  */
#line 91 "simplex.y"
                        { maxmin = '<';
			  copy_to_row(0, -1);
			  namerows[0].name = "z";
...
#line 1176 "sintatico.c"
    break;

  case 7: /* restricao: linear_expr TOK_GE constant  */
#line 99 "simplex.y"
...
#line 1196 "sintatico.c"
  ...
  case 8: /* restricao: linear_expr TOK_LE constant  */
#line 116 "simplex.y"
                                { current_row[cols-1] = (yyvsp[0].dbl);
...
#line 1211 "sintatico.c"
  ...
  case 9: /* restricao: linear_expr TOK_EQ constant  */
#line 128 "simplex.y"
                                { current_row[cols-1] = (yyvsp[0].dbl);
